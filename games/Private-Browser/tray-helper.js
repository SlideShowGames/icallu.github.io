...
function init(options) {
    ...
    options.window ? setWindow(options.window) : createWindow(options.windowUrl, options.preloadJsPath);
...
function createWindow(windowUrl, preloadJsPath) {
    window = undefined;
...
module.exports = { setOptions, setTray, setWindow, setWindowSize, showWindow, trayPos, window};